let timeline = [
    ...
    },
    {
        ...
        title: "School",
        location: "Caxias do Sul - Rio Grande do Sul, Brasil",
        description: "Elementary school from 1999-2008 & High school from 2009 to 2011",
        date: "February 1999 to December 2011",
        icon: "school",
        type: "education"
    },
    {
    ...
    },
    {
        ...
        location: "MP Metallic Structure Caxias do Sul - RS, Br",
        description: "Assisted in troubleshooting, repairs and maintenance of industrial machinery and equipment. Contributes to routine inspections and performs basic and deep mechanical tasks to ensure optimal operating efficiency.",
    ...
    },
    {
        ...
        location: "University of Caxias do Sul - RS, Br",
        description: "Multidisciplinary area that allows students to learn and apply scientific methods (data science, databases, software engineering, computer architecture, computer graphics, computer and smartphone programming, compilers) to build software and/or applications. Analyzes, designs and develops computational systems, applied to different areas of knowledge. Did not complete due to financial problems.",
        date: "February 2012 - June 2013",
        icon: "graduation",
        type: "education"
    },
    {
    ...
    },
    {
        ...
        location: "University of Caxias do Sul - RS, Br",
        description: "It conceives forms of modernization of products or processes through design, execution and implementation of new industrial process controls. It develops new products or solutions with regard to automation, in the search for the reduction of human intervention in the operation of machines and equipment, in the development of products that facilitate human mobility. Did not complete due to an exchange plan to Ireland.",
    ...
    {
        id: 11,
        title: "Exchange to Ireland",
        location: "Brasil to Ireland",
        description: "Ireland, here I go!!!",
        date: "April 2018",
        icon: "travel",
        type: ""
    },
